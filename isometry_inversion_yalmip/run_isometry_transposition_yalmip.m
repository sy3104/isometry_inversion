...
%'D'-dimensional space into its transpose map.
...
%Create a maximally entangled state and multiply by the dimension 'd' and 'D'
...
for i=1:n 
    ...
    %Define the Target operator as the transpose of V
        Vt=V.';
    %Creates the Choi operator for the unitary U' and stock at a tensor for
    %the output
...
%d-dimensional space to D-dimensional space into its transpose map
[maxp S F]=maxp_yalmip(D, d, d, D, Jin, Jout, k, choose_protocol, isComplex);
