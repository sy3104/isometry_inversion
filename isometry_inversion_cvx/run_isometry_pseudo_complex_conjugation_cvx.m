...
%'D'-dimensional space into its pseudo complex conjugate map.
...
%d-dimensional space to D-dimensional space into its pseudo complex
%conjugate map
[maxp S F]=maxp_isometry_pseudo_complex_conjugation_cvx(d, D, Jin, k, choose_protocol, isComplex);
